...
const config = {
  ...
  minDeposit: parseInt(process.env.MIN_DEPOSIT) || 500,
  minWithdrawal: parseInt(process.env.MIN_WITHDRAWAL) || 1000,
  ...
  welcomeBonus: parseInt(process.env.WELCOME_BONUS) || 10000,
